...
def load_select_action_page(role):
    ...
    def next_action():
        ...
        elif selected_action == "Enter Day Closeout":
    ...
    def load_add_employee_form():
        ...
        back_button = tk.Button(root, text="Back to Actions", command=lambda: load_select_action_page(role),
    ...
    def load_payroll_page():
        ...
        back_button = tk.Button(root, text="Back", command=lambda: load_select_action_page(role), width=20,
                                bg="black",
                                fg="white")
